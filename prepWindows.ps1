#####################################################
#   prepWindows.ps1                                 
#   https://github.com/local-projects/prepWindows  
#
# Resources:
#   Sysprep: https://technet.microsoft.com/en-us/library/hh824938.aspx
#
#####################################################

# Following are the features this script needs:
* Enable Powershell
* Set powershell as default command prompt
* Install chocolatey
* Disable sleep mode
